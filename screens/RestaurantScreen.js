...
import { MapIcon, QuestionMarkCircleIcon } from "react-native-heroicons/outline"
import DishRow from '../components/DishRow'
import BasketIcon from '../components/BasketIcon'
import { useDispatch } from 'react-redux'
import { setRestaurant } from '../featureds/restaurantSlice'
      ...
      <ScrollView>
        ...
        <View className="relative">
          <Image source={{
            ...
            className="w-full h-56 bg-gray-300 px-4"
          />
        ...
        <View className="bg-white">
          <View className="px-4 pt-4">
            ...
            <Text className="mt-2 text-gray-500 pb-4">{short_description}</Text>
          </View>
